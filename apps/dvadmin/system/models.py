...
from utils.apps.dvadmin.models import CoreModel, table_prefix
...
class Users(AbstractUser, CoreModel):
    ...
    email = models.EmailField(max_length=255, unique=True, db_index=True, verbose_name="邮箱", null=True, blank=True, help_text="邮箱")
