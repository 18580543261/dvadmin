...
from apps.dvadmin.system.views.login import LoginView, CaptchaView, ApiLogin, ECaptchaView
from utils.apps.dvadmin.swagger import CustomOpenAPISchemaGenerator
...
urlpatterns = [
    ...
    path('api/system/', include('apps.dvadmin.system.urls')),
    path('api/login/', LoginView.as_view(), name='token_obtain_pair'),
    path('token/refresh/', TokenRefreshView.as_view(), name='token_refresh'),
    re_path(r'^api-auth/', include('rest_framework.urls', namespace='rest_framework')),
    path('api/captcha/', CaptchaView.as_view()),
    path('api/ecaptcha/', ECaptchaView.as_view()),
